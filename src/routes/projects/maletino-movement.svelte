			...
			<div class="flex flex-col sm:flex-row mt-10">
				...
				>
					<p class="leading-relaxed text-lg mb-4">
						...
						beer drinking vinegar sartorial, disrupt fashion axe normcore meh butcher. Portland 90's
						scenester vexillologist forage post-ironic asymmetrical, chartreuse disrupt butcher
